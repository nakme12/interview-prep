...
Frontend Technologies: Next.js, React.js, JavaScript ES6+, HTML5, CSS3, Responsive Design, Mobile-first Development, Component Architecture, Server-side Rendering (SSR), Static Site Generation (SSG)

Backend/Full-Stack: API Routes, Node.js basics, RESTful API integration, Database integration patterns
...
Development Practices: Code Reviews, Debugging, Performance Optimization, Lazy Loading, Asynchronous JavaScript, Testing Frameworks (Jest, React Testing Library), Accessibility Standards, SEO Optimization

Tools & Platforms: VS Code, Cursor, Windsurf, Chrome DevTools, Postman, Figma, npm/yarn, Vercel
...
Achieved ~40% reduction in initial load time through optimization techniques
